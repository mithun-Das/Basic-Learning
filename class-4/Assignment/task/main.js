...
window.onload = function(){
       ...
       /***********  Fetch the data of a  row in the input field  when edit button is clicked****************/
		...
		function  storeData(task , mentor , date){
         ...
         /**************  Check either an element exist already  *********/


        function   checkExistence(){
        	
           let taskName = JSON.parse(localStorage.getItem(document.getElementById("task").value));
        ...
        /**********  Updated Entire Row will be stored   ************/
           

        function   storeUpdatedRow(){
        ...
        /*************  Show updated entire row on running page ***************/
		...
		function  getInputData(){          
		   ...
		   if(checkExistence() == 1){             /*************  disaster part of this task.A new solution is need **********/
